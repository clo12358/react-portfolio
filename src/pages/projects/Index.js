            ...
            <div className="flex flex-col sm:flex-row p-8 sm:p-10 gap-8 sm:gap-14">
              ...
              <div className="w-full sm:w-[55%] flex flex-col justify-center sm:items-start gap-6">
                ...
                <div className="space-y-4 w-full">
                  <h2 className="text-4xl sm:text-5xl font-handwriting text-primary 
                               drop-shadow-sm text-center sm:text-left">
                    {project.title}
                  </h2>
                  <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
                    {project.categories.map((category, i) => (
                      <span
                        key={i}
                        className="px-4 py-1.5 bg-secondary/10 text-secondary 
                ...
                <Link
                  ...
                  className="bg-secondary text-white font-medium px-6 py-3 
